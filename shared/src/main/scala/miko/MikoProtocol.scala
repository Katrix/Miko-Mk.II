...
import miko.services.{ClientMessage, ServerMessage}
...
trait MikoProtocol extends DiscordProtocol {
  ...
  implicit val webWsServerMessageCodec: Codec[ServerMessage] = {
    import io.circe.generic.extras.auto._
    deriveConfiguredCodec
  }

  implicit val webWsClientMessageCodec: Codec[ClientMessage] = {
    import io.circe.generic.extras.auto._
    deriveConfiguredCodec
  }
}
